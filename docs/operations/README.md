...
| 文档 | 读者 | 内容 |
|------|------|------|
| [runbook.md](./runbook.md) | 运维、量化、审批人 | **主手册**：运行前准备、API key/私钥/funder、充值、提现、报告、operator/policy authorization 下单、卖出、赎回、事故处理 |
...
| [docker-integration.md](./docker-integration.md) | CI / 开发 | current `system` partition 与 disposable production-stack 测试 |
| [network-integration.md](./network-integration.md) | Operational Activation | 需外网/凭证的 Polymarket / RPC 手工证据（非 Phase 12 closure） |
...
- [Phase 12 execution authority](../plans/quant-pivot/phase-12/12.0-execution-authority-account-recovery-fast-feedback.md) — 执行授权、账户恢复、经济反馈与治理背景
...
- [schema-catalog.md](../persistence/schema-catalog.md) — PostgreSQL/ClickHouse 唯一 fresh-bootstrap schema 规范
