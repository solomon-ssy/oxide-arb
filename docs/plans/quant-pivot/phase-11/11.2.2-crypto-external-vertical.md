...
> 表达，category model 任一故障整轮失败，禁止 category→generic 或 ZeroWeight fallback。当前唯一版本组合是
> runtime config v10 / feature schema v6，本文后文的 v5 只记录当时的历史实施波次，不是可激活 wire contract。
>
