...
- 链：Polygon mainnet；RPC 来自 `[polymarket.onchain].rpc_url`；relayer 来自 `[polymarket.relayer]`。
...
# api_key = "..."        # QUANT_PIVOT__POLYMARKET__RELAYER__API_KEY
# api_key_address = "0x..." # QUANT_PIVOT__POLYMARKET__RELAYER__API_KEY_ADDRESS
