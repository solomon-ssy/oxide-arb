...
> 父：[`README.md`](README.md) · 数据源调研：[`03.8-domain-data-sources.md`](03.8-domain-data-sources.md) ·
...
Polymarket crypto 市场结算源即 **Binance BTC/USDT 1m close**（见 [`03.8`](03.8-domain-data-sources.md) §2）。
...
> [`03.8`](03.8-domain-data-sources.md)。
