...
> [`domain-data-sources.md`](../../operations/domain-data-sources.md)）。**3.5 已交付**，垂直工作
...
> 数据源：[`domain-data-sources.md`](../../operations/domain-data-sources.md) ·
...
**目标**：Crypto 特征源 = 结算源 = **Binance BTC/USDT klines**（[domain-data-sources](../../operations/domain-data-sources.md) §2）。
...
| 能力 | 说明 |
|------|------|
| Sports/Politics/Weather/Geopolitics 真实外部源 | 按 [domain-data-sources](../../operations/domain-data-sources.md) 加性扩展 W1–W4 |
