...
- **smartcore classical shadow**：Crypto tabular（distance_to_strike + momentum + vol）→ payout
  `LogisticRegression`；未形成 calibrated payout distribution 前不得 active serving。
