//! Test-only report lifecycle seeding through the production prepare/publication contract.

use chrono::{Duration, Utc};
use quant_pivot_models::{
    domain::{NewReportTransaction, RecommendationReportInfo, ReportRunClaim},
    entities::quant_report_run,
    enums::quant::{
