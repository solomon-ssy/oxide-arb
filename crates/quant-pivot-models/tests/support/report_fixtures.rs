//! Report builders colocated with report payload snapshot contracts.
//!
//! Defaults are deterministic; parameters cover the dimensions payload
//! snapshots actually vary (id, status, kind, market, side, rank, and USD).
