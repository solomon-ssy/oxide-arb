    ...
    pub(super) const ALL: &'static [Self] = &[
        ...
        Self::new(
            ...
            &[
                ...
                "market_data.finalized_exchange_history.max_response_bytes",
            ...
            "Always",
            "Timeout, attestor request span/concurrency, response-byte, adaptive logical-chunk, retry, worker, and batch budgets must form valid bounded ranges.",
        ),
        Self::new(
