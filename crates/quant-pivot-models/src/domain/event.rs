//! Cross-subsystem event bus payload + non-blocking publisher (Phase 0).

use crate::{
    domain::{MarketBookView, SystemStatus, control_factor::ControlFactorMaterializationRunInfo},
    enums::{
...
pub enum CoreEvent {
    ...
    MaterializationRunUpdated(Box<ControlFactorMaterializationRunInfo>),
}
