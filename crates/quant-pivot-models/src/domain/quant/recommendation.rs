...
use crate::{
    ...
    types::{
        AccountSnapshotId, Bps, EntryPlan, EquitySnapshotId, EventId, EvidenceRefs,
        ExecutionEligibility, ExitPlan, MarketContext, MarketId, MarketSelectionId, ModelVersionId,
        PortfolioPlanId, Probability, RecommendationFactorBreakdown, RecommendationId,
...
info_from_model!(RecommendationInfo, crate::entities::quant_recommendation::Model, {
    ...
    data_quality_score, model_score_percentile, entry_plan, sizing_plan, exit_plan, risk_envelope,
