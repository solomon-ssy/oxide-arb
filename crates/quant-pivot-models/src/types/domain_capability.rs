...
pub enum DomainCapabilityReasonCode {
    ...
    WeatherDailyTruthUnavailable,
    WeatherAmbiguousFractionalBucketOwnership,
    WeatherAmbiguousRangeOwnership,
    WeatherTemplateEvidenceIncomplete,
    WeatherOfficialSourceUnavailable,
    WeatherReleasePolicyUnavailable,
    WeatherAggregationPolicyUnsupported,
    WeatherAqiOfficialDailyUnavailable,
...
impl WeatherVariable {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CycloneLandfallIntensity => "cyclone_landfall_intensity",
    ...
    pub fn parse(value: &str) -> Option<Self> {
        match value {
            ...
            "cyclone_landfall_intensity" => Some(Self::CycloneLandfallIntensity),
