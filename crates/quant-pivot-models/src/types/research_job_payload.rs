...
use crate::{
    domain::{
        ...
        ports::{
            BiasTableFitJobParams, FeedbackCalibrationJobParams, FeedbackComparisonJobParams,
            FeedbackCpcvJobParams, FeedbackDatasetSealJobParams, FeedbackDecisionJobParams,
            FeedbackShadowJobParams, FeedbackTrainingJobParams, ModelCalibrationFitJobParams,
        },
    },
...
pub enum ResearchJobParams {
    ...
    FeedbackShadowReplay(Box<FeedbackShadowJobParams>),
...
impl ResearchJobParams {
    ...
    pub const fn kind(&self) -> ResearchJobKind {
        match self {
            ...
            Self::FeedbackShadowReplay(_) => ResearchJobKind::FeedbackShadowReplay,
