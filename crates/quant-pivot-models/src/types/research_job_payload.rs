...
use crate::{
    domain::{
        ...
        ports::{
            BiasTableFitJobParams, FeedbackAttributionPlanJobParams, FeedbackCalibrationJobParams,
            FeedbackComparisonJobParams, FeedbackCpcvJobParams, FeedbackDatasetSealJobParams,
            FeedbackDecisionJobParams, FeedbackShadowJobParams, FeedbackTrainingJobParams,
...
pub enum ResearchJobParams {
    ...
    FeedbackAttributionPlan(FeedbackAttributionPlanJobParams),
...
impl ResearchJobParams {
    ...
    pub const fn kind(&self) -> ResearchJobKind {
        match self {
            ...
            Self::FeedbackAttributionPlan(_) => ResearchJobKind::FeedbackAttributionPlan,
