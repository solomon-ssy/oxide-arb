//! Strong-typed recommendation report builders colocated with core unit tests.
//!
//! Defaults are deterministic; parameters cover the dimensions core tests
//! actually vary (id, status, kind, market, side, rank, and hard reservation).
...
use quant_pivot_models::{
    domain::{
        ...
        quant::{
            ...
            PassiveEntryEconomics, RecommendationEconomics, RecommendationInfo,
            RecommendationReportInfo, RepresentedRouteSet, ScenarioCapitalOccupancySlice,
            ScenarioEntryExecution, ScenarioExecutionCashflow,
        },
    },
    enums::{
        ...
        market::MarketStatus,
        quant::{
            AccountSource, ExitSettlementMode, FactorDirection, IneligibilityReason, OutcomeSide,
    ...
    types::{
        AccountSnapshotId, BookSnapshotRef, Bps, ContentHash, DataQualitySummary,
        DecisionPolicySnapshotId, EconomicTierId, EligibilitySummary, EntryConditionPlan,
        EntryMakerRebateTerms, EntryOrderPolicy, EntryPlan, EquitySnapshotId, EventId,
        EvidenceRefs, ExecutionEligibility, ExitPlan, FactorBreakdownEntry, FeatureVectorId,
        MakerRebateDelayBasis, MakerRebateObjectiveStatus, MakerRebateScenarioCreditStatus,
        MakerRebateValuationEvidence, MakerRebateValuationHealth, MarketContext, MarketId,
        MarketSelectionId, ModelRunId, ModelVersionId, OpportunisticExitPolicy,
        ...
        ReportDataQualitySnapshotId, ReportRouteRunId, ReportRunId, ReportSummary, RiskEnvelope,
        ...
        TradePolicyCohortProvenance, TradePolicyEntryRoute, Usd, UsdHours,
...
fn economic_tier(
    ...
    ExecutableEconomicTier {
        ...
        entry_execution: EntryExecutionEconomics::Passive(Box::new(PassiveEntryEconomics {
            ...
            maker_rebate_terms: EntryMakerRebateTerms::PassiveNoProgram {
                terms_hash: content_hash(),
                available_at: Utc.timestamp_opt(1_700_000_000, 0).unwrap(),
            },
            full_fill_maker_rebate_accrual_usd: Usd::ZERO,
            expected_maker_rebate_accrual_usd: Usd::ZERO,
            objective_maker_rebate_usd: Usd::ZERO,
            maker_rebate_objective_status: MakerRebateObjectiveStatus::NoProgram,
...
fn sizing_plan(hard_reserved_cash_usd: Usd) -> SizingPlan {
    ...
    SizingPlan {
        ...
        rebate_valuation_hash: Some(content_hash()),
        maker_rebate_terms: EntryMakerRebateTerms::PassiveNoProgram {
            terms_hash: content_hash(),
            available_at: Utc.timestamp_opt(1_700_000_000, 0).unwrap(),
        },
