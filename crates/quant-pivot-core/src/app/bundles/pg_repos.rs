...
use quant_pivot_repository::postgres::{
    PgAccountSnapshotRepository, PgArchivePartitionRepository, PgAttributionRepository,
    PgBacktestPathSetRepository, PgBacktestReportRepository, PgBasisAlertRepository,
    PgCalibrationArtifactRepository, PgCapitalAllocationRepository, PgCatalogVersionRepository,
...
pub struct PgRepositories {
    ...
    pub archive_partition: Arc<PgArchivePartitionRepository>,
...
impl PgRepositories {
    ...
    pub fn wire(pg: &PostgresPool, gamma: &GammaConfig) -> Self {
        ...
        Self {
            ...
            archive_partition: arc_repo(&db, PgArchivePartitionRepository::new),
