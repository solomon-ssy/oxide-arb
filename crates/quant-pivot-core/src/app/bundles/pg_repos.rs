...
impl PgRepositories {
    ...
    pub fn wire(pg: &PostgresPool) -> Self {
        ...
        Self {
            ...
            runtime_control: arc_repo(&db, PgRuntimeControlRepository::new),
            ...
            execution_account: arc_repo(&db, PgExecutionAccountRepository::new),
            ...
            settlement_governance: arc_repo(&db, PgSettlementGovernanceRepository::new),
            recommendation: arc_repo(&db, PgRecommendationRepository::new),
            recommendation_resolution_outcome: arc_repo(
                &db,
                PgRecommendationResolutionOutcomeRepository::new,
            ),
            recommendation_execution_outcome: arc_repo(
                &db,
                PgRecommendationExecutionOutcomeRepository::new,
            ),
            recommendation_report: arc_repo(&db, PgRecommendationReportRepository::new),
            report_run: arc_repo(&db, PgReportRunRepository::new),
            ...
            domain_source_expectation: arc_repo(&db, PgDomainSourceExpectationRepository::new),
