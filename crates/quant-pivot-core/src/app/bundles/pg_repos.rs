...
pub struct PgRepositories {
    ...
    pub favorite_longshot_bias_table: Arc<PgFavoriteLongshotBiasTableRepository>,
...
impl PgRepositories {
    ...
    pub fn wire(pg: &PostgresPool) -> Self {
        ...
        Self {
            ...
            favorite_longshot_bias_table: arc_repo(&db, PgFavoriteLongshotBiasTableRepository::new),
