...
const NAME: &str = "m20260716_000003_query_indexes";
const SOURCE: &[u8] = include_bytes!("m20260716_000003_query_indexes.rs");
...
const INDEXES: &[IndexSpec] = &[
    ...
    IndexSpec {
        ...
        columns: &[
            IndexColumnSpec {
                name: "runtime_config_version_id",
                direction: IndexDirection::Asc,
            },
            IndexColumnSpec {
                name: "decision_at",
    ...
    IndexSpec {
        name: "idx_runtime_config_approval_version_decided",
