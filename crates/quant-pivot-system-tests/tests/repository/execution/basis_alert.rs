//! Basis-cross-check alert ledger persistence system contracts.
//!
...
//! which a mock repository can prove.

use chrono::{DateTime, Duration as ChronoDuration, TimeZone, Utc};
use quant_pivot_models::{
    domain::{api::BasisAlertListQuery, pagination::PageRequest, quant::NewBasisAlert},
...
fn alert(market_id: &str, basis: i64, as_of: DateTime<Utc>) -> NewBasisAlert {
    NewBasisAlert {
        ...
        basis_bps: Bps::new(dec!(1) * Decimal::from(basis)),
