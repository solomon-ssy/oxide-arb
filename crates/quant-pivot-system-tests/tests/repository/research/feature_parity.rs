//! Feature-parity incident-ledger persistence system contracts.
...
use quant_pivot_models::{
    domain::{
        ...
        quant::{CompleteFeatureParityRun, NewFeatureParityRun, NewResearchJob},
    },
