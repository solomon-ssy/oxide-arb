//! Append-only trade-policy trial-ledger persistence system contracts.
...
use quant_pivot_models::{
    domain::{
        ...
        quant::{NewResearchJob, NewTradePolicyTrialAttempt},
    },
    enums::quant::{
...
fn successful_attempt(
    ...
    let mut attempt = NewTradePolicyTrialAttempt {
        ...
        metrics_json: Some(TradePolicyTrialMetrics {
            ...
            expected_net_return_bps: Decimal::from(25),
            risk_net_return_bps: Decimal::from(25),
