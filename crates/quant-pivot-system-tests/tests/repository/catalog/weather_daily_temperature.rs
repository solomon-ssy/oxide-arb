//! Daily weather projection, correction, and event-chain persistence system contract.

use chrono::{DateTime, Duration, NaiveDate, TimeZone, Utc};
use quant_pivot_models::{
    domain::{
        data_plane::{
            DomainEventType, DomainSourceCheckpoint, WeatherObservationReport,
            WeatherObservationReportKind,
        },
        quant::WeatherDailyTemperatureProjectionInfo,
    },
    types::{
