CREATE TABLE IF NOT EXISTS book_decision_contexts (
    ...
    yes_token_id          String,
    no_token_id           String,
    decision_stage        Enum8('OpportunityDetected' = 1, 'RiskGateEvaluated' = 2, 'SizeComputed' = 3, 'OrderPrepared' = 4, 'OrderSubmitted' = 5, 'OrderFilled' = 6, 'OrderMissed' = 7, 'OrderFailed' = 8, 'SettlementAttributed' = 9),
