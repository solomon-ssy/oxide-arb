...
pub use quant::{
    ...
    PgFeedbackRecipeTemplateRepository, PgFeedbackSchedulerRepository, PgMarketLinkageRepository,
    PgMarketSelectionRepository, PgModelCandidateManifestRepository,
    ...
    PgPortfolioPlanRepository, PgPositionRepository, PgPromotionPermitRepository,
